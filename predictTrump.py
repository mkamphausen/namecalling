...
df = pd.read_csv('data/trump_processed/trump_filtered_english.csv',sep=',', encoding='utf-8', on_bad_lines='skip', low_memory=False, lineterminator='\n')
...
df_output.to_csv('data/trump_processed/biden_with_predictions.csv', index=False)
