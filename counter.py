...
def count_values_in_column(file_path, column_name):
    # CSV-Datei einlesen
    df1 = pd.read_csv('biden_output_with_predictions.csv',sep=',', encoding='utf-8', on_bad_lines='skip', low_memory=False, lineterminator='\n')
    df2 = pd.read_csv('trump_output_with_predictions.csv',sep=',', encoding='utf-8', on_bad_lines='skip', low_memory=False, lineterminator='\n')
...
column_name = 'deine_spalte'      # Name der Spalte anpassen
count_values_in_column(file_path, column_name)
